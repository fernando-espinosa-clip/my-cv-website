...
export function Skills() {
  ...
  return (
    <section id="skills" className="py-20 px-8 md:px-16 bg-[#2a2a2a]">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold text-white mb-2">{t.skills.title}</h2>
        <div className="w-16 h-1 bg-primary mb-12"></div>

        <div className="mb-16">
          <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-8">{t.skills.subtitle}</h3>
          <p className="text-gray-400 mb-12 max-w-3xl">
            {t.skills.description}
          </p>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {t.skills.circular.map((skill, index) => (
              <CircularProgress 
                key={index}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {/* Knowledge List */}
          <div>
            <h3 className="text-xl font-bold text-white mb-6">{t.skills.knowledgeTitle}</h3>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {t.skills.knowledgeList.map((skill) => (
          ...
          {/* Language Skills */}
          <div>
            <h3 className="text-xl font-bold text-white mb-6">{t.skills.languagesTitle}</h3>
